...
class MyTransformerDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        if self.norm_first:
            ...
            mha_x, mha_scores = self._mha_block(
    ...
    def _sa_block(
        ...
        x = self.self_attn(
            x, x, x, attn_mask=attn_mask, key_padding_mask=key_padding_mask, is_causal=is_causal, need_weights=True
        )[0]
    ...
    def _mha_block(
        ...
        x, mha_scores = self.multihead_attn(
            x,
            mem,
            mem,
            attn_mask=attn_mask,
    ...
    def inference_step(self, X):
        ...
        with torch.no_grad():
            ...
            for i in range(self.max_seq_len):
                ...
                decoder_output, att_score = self.transformer_decoder(
                    tgt=target_seq, memory=features
                )  # (1, seq_len, d_model)
                # print(decoder_output.shape)
